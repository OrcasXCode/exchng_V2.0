                ...
                <div className="flex flex-col px-3">
                            ...
                            <div className="flex flex-col relative">
                                ...
                                <div className="flex flex-row absolute right-1 top-1 p-2">
                                    <div className="relative">
                                        <img src="https://backpack.exchange/_next/image?url=%2Fcoins%2Fusdc.png&w=32&q=75" className="w-6 h-6" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-col relative">
                            ...
                            <div className="flex flex-row absolute right-1 top-1 p-2">
                                <div className="relative">
                                    <img src="https://backpack.exchange/_next/image?url=%2Fcoins%2Fsol.png&w=32&q=75" className="w-6 h-6" />
                                </div>
                            </div>
                        </div>
